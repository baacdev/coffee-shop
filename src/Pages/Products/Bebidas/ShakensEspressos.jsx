...
const shakensEspressos = [
  {
    id: 1,
    name: 'Brown Sugar Shaken Espresso Frio con Bebida de Avena',
    href: '#',
    ...
    imageAlt: 'Bebida',
    price: 'S/ 16.50',
    description: 'Bebida helada hecha a base de espresso, jarabe de azúcar morena y canela en polvo completada con bebida de avena y cubos de hielo.',
    sizes: [
      {
        name: 'Alto',
        millilimiters: '300',
  ...
  {
    id: 2,
    name: 'Toasted Vanilla Shaken Espresso Frio con Bebida de Avena',
    href: '#',
    ...
    imageAlt: 'Bebida',
    price: 'S/ 16.50',
    description: 'Bebida helada hecha a base de espresso, jarabe de vainilla tostada, completada con bebida de avena y cubos de hielo.',
    sizes: [
      {
        name: 'Alto',
        millilimiters: '300',
...
function ShakensEspressos() {
  const [open, setOpen] = useState(false)
  const [selectedShakenEspresso, setSelectedShakenEspresso] = useState(shakensEspressos[0])
  ...
  return (
    <div className='flex flex-col justify-between mx-auto max-w-2xl px-4 py-1 sm:px-6 sm:py-10 lg:max-w-7xl lg:px-8'>
      <div className='mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-2 xl:gap-x-20'>
        {shakensEspressos.map((shakenEspresso) => (
          <div key={shakenEspresso.id} className='group relative flex' onClick={() => handleShakenEspressoClick(shakenEspresso)}>
            ...
            <div className='ml-4 flex flex-col justify-center'>
              ...
              <p className='text-gray-900 text-sm font-semibold font-opensans'>Desde: {shakenEspresso.price}</p>
            </div>
          </div>
        ))}
      </div>
...
export default ShakensEspressos