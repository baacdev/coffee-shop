...
const desayunos = [
  {
    ...
    name: 'Dúo Desayuno',
    href: '#',
    imageSrc: 'https://www.starbucks.pe/Multimedia/productos/DUO_DESAYUNO_HOLIDAY_202311141341420916.PNG',
    imageAlt: 'Packs',
    price: 'S/ 11.00',
    description: '¡Tu desayuno favorito! Disfruta de un Americano, Latte, Vainilla Latte o Chocolate Caliente y combínalo con un Croissant de mantequilla, Sandwich Panino Vesubio o Sandwich Pavo y queso. Imágenes referenciales. Válido del 02.01.2024 AL 26.06.2024.',
    sizes: [
      {
        name: 'Alto',
        millilimiters: '300',
  ...
  {
    id: 2,
    name: 'Desayuno Para Dos - Alto',
    href: '#',
    imageSrc: 'https://www.starbucks.pe/Multimedia/productos/DESAYUNO_PARA_DOS_V4.png',
    imageAlt: 'Packs',
    price: 'S/ 30.00',
    description: '¡Inicia tu mañana con un desayuno para dos! Elige dos de tus bebidas favoritas + dos sándwiches y comparte un momento especial. Válido del 02.01.2024 al 26.06.2024 o hasta agotar stock de 10 promociones.',
    sizes: [
      {
        name: 'Alto',
        millilimiters: '300',
...
function Desayunos() {
  ...
  const [selectedDesayuno, setSelectedDesayuno] = useState(desayunos[0])
  const [selectedSize, setSelectedSize] = useState(selectedDesayuno.sizes[0])

  const handleDesayunoClick = (desayuno) => {
    setSelectedDesayuno(desayuno)
    setSelectedSize(desayuno.sizes[0])
    setOpen(true)
  }
  return (
    <div className='flex flex-col justify-between mx-auto max-w-2xl px-4 py-1 sm:px-6 sm:py-10 lg:max-w-7xl lg:px-8'>
      <div className='mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-2 xl:gap-x-20'>
        {desayunos.map((desayuno) => (
          <div key={desayuno.id} className='group relative flex' onClick={() => handleDesayunoClick(desayuno)}>
            <div className='flex-shrink-0 size-32 lg:h-60 lg:w-60 overflow-hidden'>
              <img
                src={desayuno.imageSrc}
                alt={desayuno.imageAlt}
            ...
            <div className='ml-4 flex flex-col justify-center'>
              ...
              <p className='text-gray-900 text-sm font-semibold font-opensans'>Desde: {desayuno.price}</p>
            </div>
          </div>
        ))}
      </div>
                  ...
                  <div className='relative flex w-full items-start overflow-hidden bg-white px-4 pb-8 pt-16 shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8'>
                    ...
                    <div className='grid grid-cols-1 items-start gap-x-6 gap-y-8 sm:grid-cols-12 lg:gap-x-8 w-full'>
                      <div className='flex-shrink-0 size-60 lg:h-full lg:w-full overflow-hidden rounded-lg bg-gray-100 sm:col-span-4 lg:col-span-5 flex items-center justify-center mx-auto'>
                        <img
                          src={selectedDesayuno.imageSrc}
                          alt={selectedDesayuno.imageAlt}
                          className='object-cover object-center size-full lg:size-auto'
                        />
                      </div>
                      <div className='sm:col-span-8 lg:col-span-7'>
                        <h2 className='text-2xl font-bold text-gray-900 sm:pr-12'>{selectedDesayuno.name}</h2>
                        ...
                        <section aria-labelledby='information-heading' className='mt-2'>
                          ...
                          <p className='text-sm text-gray-900 lg:text-lg'>{selectedDesayuno.description}</p>
                        </section>
                        ...
                        <section aria-labelledby='options-heading' className='mt-10'>
                          <form>
                            ...
                            <fieldset aria-label='Choose a Size'>
                              ...
                              >
                                {selectedDesayuno.sizes.map((size) => (
                                  <Radio
                                    key={size.name}
                                    value={size}
